...
!JSON.parse(localStorage.getItem('products')) && localStorage.setItem('products', JSON.stringify(productsImported));

const isMenOrWomen = JSON.parse(localStorage.getItem('isMenOrWomen')) || 'Women'
...
isMenOrWomenLink.addEventListener('click', (e) => {
    const toSet = JSON.parse( localStorage.getItem('isMenOrWomen') ) || isMenOrWomen
...
products.filter((el) => (el.isMenOrWomen === isMenOrWomen)).forEach((element,i) => {
